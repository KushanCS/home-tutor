                    ...
                    <form action="CourseManagementServlet" method="post">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="level" name="level" required>
                                    <option value="Beginner" ${course.level eq 'Beginner' ? 'selected' : ''}>Beginner</option>
                                    <option value="Intermediate" ${course.level eq 'Intermediate' ? 'selected' : ''}>Intermediate</option>
                                    <option value="Advanced" ${course.level eq 'Advanced' ? 'selected' : ''}>Advanced</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="duration"
                                   name="duration" value="${course.duration}" required>
                        </div>
