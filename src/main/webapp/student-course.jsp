        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card course-card h-100">
                <div class="card-body">
                    ...
                    <a href="CourseDetailsServlet?courseId=<%= cs.getCourseId() %>" class="course-link"></a>
                ...
                <!-- Action buttons (positioned above the clickable area) -->
                <div class="card-footer bg-white course-actions">
                    <div class="d-flex justify-content-between">
                        ...
                        <% if (!cs.isPaid()) { %>
                        <form action="ChoosePaymentMethod.jsp" method="get" class="d-inline">
                            <input type="hidden" name="courseId" value="<%= cs.getCourseId() %>">
