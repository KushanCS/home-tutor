...
<div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
            ...
            <a href="register.jsp" class="btn btn-outline-primary me-2">Register</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content p-4">
      <div class="modal-header border-0">
        <h5 class="modal-title w-100 text-center" id="registerModalLabel">Register as a Student</h5>
      ...
      <div class="modal-body">
        <form action="register" method="post">
          ...
          <select name="gender" class="form-control my-2" required>
          ...
          <input type="password" name="confirmPassword" class="form-control my-2" placeholder="Re-enter Password" required>
          <button type="submit" class="btn btn-primary w-100 mt-3">Sign Up</button>
        </form>
        <hr>
        <button class="btn btn-danger w-100 mt-2">Sign up with Google</button>
        <p class="text-center mt-3">
          Already a member? <a href="login.jsp">Login Now</a><br>
          <a href="#">Register as an Instructor</a>
        </p>
      </div>
    </div>
  </div>
